...
void lv_port_disp_init(void)
{
    ...
    /* When gcc buf_1 in section of .LVGLccm , when mdk lv_port_disp.o in RAM2*/
    static lv_color_t buf_1[MY_DISP_HOR_RES * MY_DISP_VER_RES / 2] __attribute__((section(".LVGLccm")));                          /*A buffer for 10 rows*/
